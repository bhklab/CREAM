...
############################# 1) in_path: Path to the input file (The file inclusing the functional regions)
...
############################# 5) WScutoff: Threshold used to identify WS within distribution of maximum distance between peaks for each Order of CORE
